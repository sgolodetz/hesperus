...
//#################### PUBLIC METHODS ####################
IAnimationComponent_Ptr Entity::animation_component()		{ return m_animationComponent; }
...
void Entity::save(std::ostream& os) const
{
	...
	if(m_animationComponent) m_animationComponent->save(os);
...
void Entity::set_animation_component(const IAnimationComponent_Ptr& animationComponent)			{ m_animationComponent = animationComponent; }
